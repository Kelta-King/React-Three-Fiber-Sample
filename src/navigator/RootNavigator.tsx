...
import BasicReveal3D from '../06-React-Native-Basic-Reveal-3D/BasicReveal3D';
...
import FlatlistReveal3DScreen from '../07-React-Native-Flatlist-Reveal-3D/FlatlistReveal3DScreen';
...
import Character3DScreen from '../18-React-Native-3D-Character-With-3D/Character3DScreen';
...
export type RootStackParamList = {
  ...
  BasicReveal3D: undefined;
  FlatlistReveal3D: undefined;
...
const RootNavigator = () => {
  ...
  return (
    <Stack.Navigator
      ...
      <Stack.Screen
        name="BasicReveal3D"
        component={BasicReveal3D}
        options={{
          headerShown: false,
        }}
      />
      <Stack.Screen
        name="FlatlistReveal3D"
        component={FlatlistReveal3DScreen}
        options={{
          headerShown: true,
        }}
      />
